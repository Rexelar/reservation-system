...
public class ReservationService {
    ...
    public Reservation updateReservation(
        ...
        if (reservation.status() != ReservationStatus.PENDING) {
            throw new IllegalStateException("Can not modify reservation status = " + reservation.status());
        }
    ...
    public Reservation approveReservation(
        ...
        var reservation = reservationMap.get(id);
        if (reservation.status() != ReservationStatus.PENDING) {
            throw new IllegalStateException("Can not approve reservation status = " + reservation.status());
        }
